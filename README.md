...
| `rust` | Rust conventions plus a `/dd:rust:review` command | `dd:rust:core`, `dd:rust:comments`, `dd:rust:linting`, `dd:rust:performance`, `dd:rust:serde`, `dd:rust:testing`, `dd:rust:review` |
